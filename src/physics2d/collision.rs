use crate::{Polygon, Vector2, is_nearly_equal, shape_type::ShapeType};
...
impl Collision {
    ...
    /// ```
    pub fn collide(
        shape_a: &mut ShapeType,
        position_a: Vector2,
        rotation_a: f32,
        shape_b: &mut ShapeType,
        position_b: Vector2,
        rotation_b: f32,
    ) -> Vec<Collision> {
        match (shape_a, shape_b) {
            ...
            (ShapeType::Box(a), ShapeType::Box(b)) => Self::intersect_polygons(
                a.get_transformed_vertices(position_a, rotation_a),
                position_a,
                b.get_transformed_vertices(position_b, rotation_b),
                position_b,
            ),
            (ShapeType::Polygon(a), ShapeType::Polygon(b)) => Self::intersect_polygons(
                a.get_transformed_vertices(position_a, rotation_a),
                position_a,
                b.get_transformed_vertices(position_b, rotation_b),
                position_b,
            ...
            (ShapeType::Box(b), ShapeType::Polygon(p)) => Self::intersect_polygons(
                b.get_transformed_vertices(position_a, rotation_a),
                position_a,
                p.get_transformed_vertices(position_b, rotation_b),
                position_b,
            ),
            (ShapeType::Polygon(p), ShapeType::Box(b)) => Self::intersect_polygons(
                p.get_transformed_vertices(position_a, rotation_a),
                position_a,
                b.get_transformed_vertices(position_b, rotation_b),
                position_b,
            ),

            (ShapeType::Box(b), ShapeType::Circle(c)) => Self::intersect_polygon_circle(
                position_b,
                c.get_radius(),
                b.get_transformed_vertices(position_a, rotation_a),
                position_a,
            ...
            .collect(),
            (ShapeType::Polygon(p), ShapeType::Circle(c)) => Self::intersect_polygon_circle(
                position_b,
                c.get_radius(),
                p.get_transformed_vertices(position_a, rotation_a),
                position_a,
            ...
            .collect(),
            (ShapeType::Circle(c), ShapeType::Box(b)) => Self::intersect_polygon_circle(
                position_a,
                c.get_radius(),
                b.get_transformed_vertices(position_b, rotation_b),
                position_b,
            ),
            (ShapeType::Circle(c), ShapeType::Polygon(p)) => Self::intersect_polygon_circle(
                position_a,
                c.get_radius(),
                p.get_transformed_vertices(position_b, rotation_b),
                position_b,
            ...
            (ShapeType::Circle(c), ShapeType::Concave(p)) => Self::collide_concave_with_circle(
                p,
                position_a,
                c.get_radius(),
                position_b,
            ...
            (ShapeType::Concave(p), ShapeType::Circle(c)) => Self::collide_concave_with_circle(
                p,
                position_b,
                c.get_radius(),
                position_a,
            ...
            (ShapeType::Concave(a), ShapeType::Concave(b)) => Self::collide_concave_with_concave(
                a, b, position_a, position_b, rotation_a, rotation_b,
            ),

            (ShapeType::Concave(a), ShapeType::Polygon(p)) => Self::collide_concave_with_polygon(
                a,
                p.get_transformed_vertices(position_b, rotation_b),
                position_a,
                position_b,
            ...
            (ShapeType::Concave(a), ShapeType::Box(b)) => Self::collide_concave_with_polygon(
                a,
                b.get_transformed_vertices(position_b, rotation_b),
                position_a,
                position_b,
            ...
            (ShapeType::Polygon(p), ShapeType::Concave(b)) => Self::collide_concave_with_polygon(
                b,
                p.get_transformed_vertices(position_a, rotation_a),
                position_b,
                position_a,
            ...
            .collect(),
            (ShapeType::Box(b), ShapeType::Concave(c)) => Self::collide_concave_with_polygon(
                c,
                b.get_transformed_vertices(position_a, rotation_a),
                position_b,
                position_a,
    ...
    fn intersect_polygons(
        vertices_a: &[Vector2],
        vertices_center_a: Vector2,
        vertices_b: &[Vector2],
        vertices_center_b: Vector2,
    ) -> Vec<Collision> {
    ...
    fn intersect_polygon_circle(
        circle_center: Vector2,
        circle_radius: f32,
        vertices: &[Vector2],
        vertices_center: Vector2,
    ) -> Vec<Collision> {
        let mut depth = f32::MAX;
        let mut normal = Vector2::zero();
    ...
    fn collide_concave_with_polygon(
        concave: &[Polygon],
        convex_vertices: &[Vector2],
        concave_pos: Vector2,
        convex_pos: Vector2,
        concave_rotation: f32,
    ) -> Vec<Collision> {
        ...
        for poly in concave {
            ...
            let collision =
                Collision::intersect_polygons(verts, concave_pos, convex_vertices, convex_pos);
            collision.iter().for_each(|c| collisions.push(*c));
        }

        collisions
    }

    fn collide_concave_with_circle(
        concave: &[Polygon],
        circle_center: Vector2,
        radius: f32,
        concave_pos: Vector2,
        ...
        for poly in concave {
            ...
            let collision =
                Collision::intersect_polygon_circle(circle_center, radius, verts, concave_pos);
            collision.iter().for_each(|c| collisions.push(*c));
        }
    ...
    fn collide_concave_with_concave(
        a: &[Polygon],
        b: &[Polygon],
        pos_a: Vector2,
        pos_b: Vector2,
    ...
    fn find_closest_point_on_polygon(
        circle_center: Vector2,
        vertices: &[Vector2],
    ) -> Option<usize> {
...
impl ContactPoints {
    ...
    pub fn find_contact_points(
        ...
        match (shape_a, shape_b) {
            (ShapeType::Circle(c1), ShapeType::Circle(_)) => {
                let contact = Self::find_contact_point_circle_to_circle(
                    position_a,
                    c1.get_radius(),
                    position_b,
                );
            ...
            (ShapeType::Box(a), ShapeType::Box(b)) => Self::find_contact_points_polygon_to_polygon(
                a.get_transformed_vertices(position_a, rotation_a),
                b.get_transformed_vertices(position_b, rotation_b),
            ),
            (ShapeType::Polygon(a), ShapeType::Polygon(b)) => {
                Self::find_contact_points_polygon_to_polygon(
                    a.get_transformed_vertices(position_a, rotation_a),
                    b.get_transformed_vertices(position_b, rotation_b),
                )
            }
            ...
            (ShapeType::Box(b), ShapeType::Circle(_)) => {
                let contact = Self::find_contact_point_circle_to_polygon(
                    position_b,
                    b.get_transformed_vertices(position_a, rotation_a),
                );
                ContactPoints {
            ...
            (ShapeType::Concave(a), ShapeType::Concave(b)) => {
                Self::find_contact_point_concave_to_concave(
                    a, b, position_a, position_b, rotation_b, rotation_b,
                )
            }

            (ShapeType::Concave(a), ShapeType::Polygon(p)) => {
                Self::find_contact_point_concave_to_polygon(
                    a,
                    p.get_transformed_vertices(position_b, rotation_b),
                    position_a,
                    rotation_b,
    ...
    fn find_contact_points_polygon_to_polygon(
        vertices_a: &[Vector2],
        vertices_b: &[Vector2],
    ) -> ContactPoints {
    ...
    fn find_contact_point_circle_to_polygon(
        circle_center: Vector2,
        vertices: &[Vector2],
    ) -> Vector2 {
        let mut min_distance_squared = f32::MAX;
    ...
    fn find_contact_point_concave_to_concave(
        polygons_a: &[Polygon],
        polygons_b: &[Polygon],
        pos_a: Vector2,
        pos_b: Vector2,
        ...
        for polygon_a in polygons_a {
            ...
            for poly_b in polygons_b {
                ...
                if contact_1.is_none() {
                    contact_1 = contact.contact_1;
                }
                if contact_2.is_none() {
    ...
    fn find_contact_point_concave_to_polygon(
        polygons_a: &[Polygon],
        vertices_b: &[Vector2],
        polygons_pos: Vector2,
        polygons_rot: f32,
    ) -> ContactPoints {
        let mut contact_1 = None;
        let mut contact_2 = None;
        ...
        for polygon_a in polygons_a {
            ...
            let contact = Self::find_contact_points_polygon_to_polygon(
                p.get_transformed_vertices(polygons_pos, polygons_rot),
                vertices_b,
            );
            if contact_1.is_none() {
                contact_1 = contact.contact_1;
    ...
    fn find_contact_point_concave_to_circle(
        polygons: &[Polygon],
        circle_center: Vector2,
        polygons_pos: Vector2,
        polygons_rot: f32,
        ...
        for polygon in polygons {
            ...
            let contact_point = Self::find_contact_point_circle_to_polygon(
                circle_center,
                p.get_transformed_vertices(polygons_pos, polygons_rot),
            );
    ...
    fn find_contact_point_circle_to_circle(
        center_a: Vector2,
        radius_a: f32,
        center_b: Vector2,
    ) -> Vector2 {
    ...
    fn point_segment_distance(p: Vector2, a: Vector2, b: Vector2) -> (f32, Vector2) {
        ...
        (p.distance_squared(&contact), contact)
    }
}
...
mod tests {
    ...
    fn test_intersect_polygons() {
        ...
        let collision = Collision::intersect_polygons(
            &vertices_a,
            Vector2 { x: 0.5, y: 0.5 },
            &vertices_b,
            Vector2 { x: 1.0, y: 1.0 },
    ...
    fn test_intersect_polygon_circle() {
        ...
        let collision = Collision::intersect_polygon_circle(
            circle_center,
            circle_radius,
            &vertices,
            Vector2 { x: 0.5, y: 0.5 },
